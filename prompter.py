...
2.  **Когда создавать `proactive_world_changes`?**
    ...
    *   **Смена окружения или декораций:** Если действие игрока требует обновления окружения (он выходит из таверны, телепортируется), используй `change_type: CHANGE_SCENE`.
