...
1.  **Переход в `COMBAT`:**
    *   **Главный триггер:** Персонаж совершил враждебное действие (атаковал, использовал вредоносное заклинание).
    ...
    *   **Пример:** Если персонаж в тронном зале выхватывает меч и атакует стражника, режим **НЕМЕДЛЕННО** должен стать `COMBAT`.
